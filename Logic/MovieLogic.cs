...
// Call the User microservice to make sure the user exists
        ...
        public async Task<bool> CreateMovie(MovieDTO movieDTO)
        {
            ...
            if(movieDTO.Plot.Length > 10)
            {
                var lettersOnlyPlot = new string((from c in movieDTO.Plot
            ...
            foreach (var word in plotWords)
            {
                ...
                if(dbWord == null)
                {
                    ...
                    wordIsTag = ProcessWordObject(wordObject);
        ...
        private bool ProcessWordObject(WordObject wordObject)
        {
